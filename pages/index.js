            ...
            <div className="socials flex flex-nowrap pt-8 space-x-8 justify-start px-15 md:px-24 mt-4">
                ...
                <div className="icons">
                    <a href="mailto:antdoan1999@gmail.com">
                        <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 1024 1024" height="36" width="36" 
                                                xmlns="http://www.w3.org/2000/svg"><path d="M928 160H96c-17.7 0-32 14.3-32 32v640c0 17.7 14.3 32 32 32h832c17.7 0 32-14.3 32-32V192c0-17.7-14.3-32-32-32zm-80.8 108.9L531.7 514.4c-7.8 6.1-18.7 6.1-26.5 0L189.6 268.9A7.2 7.2 0 0 1 194 256h648.8a7.2 7.2 0 0 1 4.4 12.9z"></path>
                        </svg>
                    </a>
                </div>
                <div className="icons">
